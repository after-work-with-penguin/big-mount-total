...
<!-- contents -->
<div class="content-w-envi03" id="content-main"><!-- 페이지 속성 분기 "content-w-aaa" -->
    <div class="contentVisual-w"> <!-- 비주얼 영역 -->
        ...
        <div class="contSection-right">
            ...
            <div class="contentArticle-w">
                <h4 class="contentTitle">관로형 튜브식 소독기 소개 ( IN TYPE )</h4>
                <div class="textNimgList-w">
                    <div class="textNimgList-inner">
                        <div class="textNimgList-cont">
                            ...
                            <div class="detailList-image-w"><img src="./imgs/environmental0205-01.png" alt=""></div>
                        </div>
                    </div>
                    <div class="textNimgList-inner">
                        <div class="textNimgList-cont">
                            <div class="detailList-title-w">
                                <strong class="detailList-title">소독기 외형 사진</strong>
                            </div>
                            <div class="detailList-image-w"><img src="./imgs/environmental0205-02.png" alt=""></div>
                            <div class="textNimgText-w">
                                <ul class="textNimgText-inner">
                                    <li>소독기와 제어판넬이 다이에 일체형으로 조립되어 있음.</li>
                                    <li>콘크리트 기초가 필요없이 바로 설치 가능.</li>
                                    <li>장소에 따라서 수평과 수직으로 설치 가능.</li>
                                    <li>주로 소형 마을하수도에 적합한 소독기 임.</li>
                                    <li>램프와 안정기등 소모품에 대한 단가가 저렴한 구조임.</li>
                                    <li>소모품만 사용수명후 교체하고 본체는 반영구적으로 사용가능.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
