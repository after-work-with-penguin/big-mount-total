...
$result_array = array();
if ($contact_count <= 0) {
    echo "<script> alert('존재하지 않는 페이지 입니다.'); location.href = './0301-contact-us.php' </script>";
    exit;
}
                        ...
                        <div class="boardDetail-inner">
                            ...
                            <div class="boardDetail-cont">
                                <p class="boardDetail-text">
                                    주차장 컨테이너 부스 견적 문의 답변드립니다.<br/>주차장 컨테이너 부스 견적 문의 답변드립니다.<br/>주차장 컨테이너 부스 견적 문의 답변드립니다.
                                </p>
                            </div>
                        </div>
                    </div>
